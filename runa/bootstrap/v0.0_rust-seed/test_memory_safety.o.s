...
.substring_end_2:
    ...
    movl %eax, %ecx
    cmpl $0, %ecx
    jl .bounds_error_char_at_3
    cmpl %edx, %ecx
    jge .bounds_error_char_at_3
.safe_char_at_3:
    popq %rax
    addq $8, %rsp
    movslq %ecx, %rcx
...
.char_at_end_3:
    ...
    movl %eax, %ecx
    cmpl $0, %ecx
    jl .bounds_error_char_at_4
    cmpl %edx, %ecx
    jge .bounds_error_char_at_4
.safe_char_at_4:
    popq %rax
    addq $8, %rsp
    movslq %ecx, %rcx
...
.char_at_end_4:
    ...
    .section .rodata
.LS0:
    .string "=== Memory Safety Validation ==="
.LS1:
    .string "Test 1: Multiple String Allocations"
.LS2:
    .string " string"
.LS3:
    .string "First"
...
.LS7:
    .string "Third"
.LS8:
    .string "Test 2: Substring Memory Management"
.LS9:
    .string "This is a test string for substring operations"
.LS10:
    .string "Test 3: to_string Allocations"
.LS11:
    .string "Test 4: Bounds Safety"
.LS12:
    .string "Hello"
.LS13:
    .string "Test 5: Empty String Handling"
.LS14:
    .string ""
.LS15:
    .string "=== Memory Safety Tests Complete ==="
