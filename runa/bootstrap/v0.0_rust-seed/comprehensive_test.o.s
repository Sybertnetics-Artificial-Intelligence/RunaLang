...
.substring_end_2:
    ...
    movl -16(%rbp), %eax
    cmpl $0, %eax
    jl .substring_bounds_error_3
    cmpl -32(%rbp), %eax
    jge .substring_bounds_error_3
    movl -24(%rbp), %eax
    cmpl $0, %eax
    jle .substring_bounds_error_3
    movl -16(%rbp), %eax
    addl -24(%rbp), %eax
    cmpl -32(%rbp), %eax
    jg .substring_bounds_error_3
...
.LS0:
    .string "Hello World"
.LS1:
    .string "=== Testing length_of ==="
.LS2:
    .string "=== Testing char_at ==="
.LS3:
    .string "=== Testing substring ==="
.LS4:
    .string "=== Testing concat ==="
.LS5:
    .string " Rocks"
.LS6:
    .string "Runa"
...
.LS8:
    .string "=== All string functions work! ==="
