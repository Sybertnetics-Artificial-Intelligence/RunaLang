...
hashtable_create:
    ...
    popq %rcx
    popq %r8
    call hashtable_create_with_destructors
    movq %rbp, %rsp
    popq %rbp
    ret


.globl hashtable_create_with_destructors
...
.globl hashtable_iterator_create
...
.globl hashtable_iterator_has_next
...
.globl hashtable_iterator_destroy
...
.globl src_hashtable__module_init
src_hashtable__module_init:
    pushq %rbp
    movq %rsp, %rbp
    ...
    .align 8
    .quad src_hashtable__module_init
    .section .text
