...
.STR167:    .string "[CODEGEN ERROR] Unsupported expression type"
.STR168:    .string "    movq $0, -"
.STR169:    .string "(%rbp)  # Zero array element"
.STR170:    .string "(%rbp)\n"
.STR171:    .string "String"
.STR172:    .string "List"
.STR173:    .string "    movq %rax, -"
.STR174:    .string "    movq %rax, (%rbx)"
.STR175:    .string "    movq (%rbx), %rcx"
.STR176:    .string "    addq %rax, %rcx"
.STR177:    .string "    subq %rax, %rcx"
.STR178:    .string "    imulq %rax, %rcx"
.STR179:    .string "    movq %rcx, %rax"
.STR180:    .string "    popq %rcx"
.STR181:    .string "    movq %rcx, (%rbx)"
.STR182:    .string ".L"
.STR183:    .string ":"
.STR184:    .string "    movq (%rsp), %rcx"
.STR185:    .string "    cmpq %rcx, %rax"
.STR186:    .string "    jg .L"
.STR187:    .string "    movq $1, %rax"
.STR188:    .string "    addq %rcx, %rax"
.STR189:    .string "    jmp .L"
.STR190:    .string "    movq %rax, %rdi"
.STR191:    .string "    call list_length"
.STR192:    .string "    movq (%rsp), %rax"
.STR193:    .string "    movq 8(%rsp), %rcx"
.STR194:    .string "    jge .L"
.STR195:    .string "    movq 16(%rsp), %rdi"
.STR196:    .string "    movq (%rsp), %rsi"
.STR197:    .string "    call list_get"
.STR198:    .string "    addq $1, %rax"
.STR199:    .string "    movq %rax, (%rsp)"
.STR200:    .string "    addq $24, %rsp"
.STR201:    .string "    movq %rbp, %rsp\n"
.STR202:    .string "    popq %rbp\n"
.STR203:    .string "    ret\n"
.STR204:    .string "    jz .L"
.STR205:    .string "    "
.STR206:    .string "    movq %rax, %rdi\n"
.STR207:    .string "    call print_string\n"
.STR208:    .string "    call print_integer\n"
.STR209:    .string "    pushq %rax  # Save match expression value"
.STR210:    .string ".match_end_"
.STR211:    .string ".match_case_"
.STR212:    .string "_"
.STR213:    .string "    popq %rax  # Get match expression\n"
.STR214:    .string "    pushq %rax  # Keep on stack"
.STR215:    .string "    movq (%rax), %rdx  # Load variant tag"
.STR216:    .string "    cmpq $"
.STR217:    .string ", %rdx  # Check tag for "
.STR218:    .string "    jne .match_case_"
.STR219:    .string "  # Jump to next case"
.STR220:    .string "    jne "
.STR221:    .string "  # No match, exit"
.STR222:    .string "    popq %rax  # Get variant pointer\n"
.STR223:    .string "(%rax), %rdx  # Load field "
.STR224:    .string "    movq %rdx, -"
.STR225:    .string "(%rbp, 0)  # Store "
.STR226:    .string " at stack offset"
.STR227:    .string "    jmp "
.STR228:    .string "    popq %rax  # Clean up match expression\n"
.STR229:    .string ".globl "
.STR230:    .string "    pushq %rbp"
.STR231:    .string "    movq %rsp, %rbp"
.STR232:    .string "%rdi"
.STR233:    .string "%rsi"
.STR234:    .string "%rdx"
.STR235:    .string "%rcx"
...
.STR237:    .string "%r9"
.STR238:    .string "main"
.STR239:    .string "    # Initialize command line arguments"
.STR240:    .string "    pushq %rdi  # Save argc"
.STR241:    .string "    pushq %rsi  # Save argv"
.STR242:    .string "    call runtime_set_command_line_args@PLT"
.STR243:    .string "    popq %rsi   # Restore argv"
.STR244:    .string "    popq %rdi   # Restore argc"
.STR245:    .string "    subq $2048, %rsp  # Pre-allocate generous stack space"
.STR246:    .string ", -"
.STR247:    .string "(%rbp)"
.STR248:    .string "    movq %rbp, %rsp"
.STR249:    .string "    popq %rbp"
.STR250:    .string "    ret"
.STR251:    .string "# Imports:"
.STR252:    .string "#   Import "
.STR253:    .string " as "
.STR254:    .string "[ERROR] codegen_generate: functions pointer is NULL"
.STR255:    .string ".section .rodata"
.STR256:    .string "    .string "
.STR257:    .string ".section .data"
.STR258:    .string "    .quad "
.STR259:    .string "    .quad 0  # Non-constant initializer defaults to 0"
.STR260:    .string ".section .bss"
.STR261:    .string "    .zero 8  # 8 bytes for Integer"
.STR262:    .string ".text"
.STR263:    .string "print_string:"
.STR264:    .string "    # Calculate string length"
.STR265:    .string "    movq %rdi, %rsi  # Save string pointer"
.STR266:    .string "    movq %rdi, %rcx  # Counter for strlen"
.STR267:    .string "    xorq %rax, %rax  # Length accumulator"
.STR268:    .string ".strlen_loop:"
.STR269:    .string "    cmpb $0, (%rcx)"
.STR270:    .string "    je .strlen_done"
.STR271:    .string "    incq %rcx"
.STR272:    .string "    incq %rax"
.STR273:    .string "    jmp .strlen_loop"
.STR274:    .string ".strlen_done:"
.STR275:    .string "    # Call write syscall (sys_write = 1)"
.STR276:    .string "    movq $1, %rdi     # fd = stdout"
.STR277:    .string "    movq %rsi, %rsi   # buf = string pointer (already in rsi)"
.STR278:    .string "    movq %rax, %rdx   # count = string length"
.STR279:    .string "    movq $1, %rax     # syscall number for write"
.STR280:    .string "    syscall"
.STR281:    .string "    # Print newline"
.STR282:    .string "    leaq .newline(%rip), %rsi  # newline string"
.STR283:    .string "    movq $1, %rdx     # count = 1"
.STR284:    .string "print_integer:"
.STR285:    .string "    subq $32, %rsp  # Space for string buffer (20 digits + null)"
.STR286:    .string "    # Convert integer to string"
.STR287:    .string "    movq %rdi, %rax  # integer value"
.STR288:    .string "    leaq -32(%rbp), %rsi  # buffer pointer"
.STR289:    .string "    addq $19, %rsi  # point to end of buffer (for reverse building)"
.STR290:    .string "    movb $0, (%rsi)  # null terminator"
.STR291:    .string "    decq %rsi"
.STR292:    .string "    # Handle zero case"
.STR293:    .string "    jnz .convert_loop"
.STR294:    .string "    movb $48, (%rsi)  # '0' character"
.STR295:    .string "    jmp .convert_done"
.STR296:    .string ".convert_loop:"
.STR297:    .string "    jz .convert_done"
.STR298:    .string "    movq $10, %rbx"
.STR299:    .string "    xorq %rdx, %rdx"
.STR300:    .string "    divq %rbx  # %rax = quotient, %rdx = remainder"
.STR301:    .string "    addq $48, %rdx  # convert remainder to ASCII"
.STR302:    .string "    movb %dl, (%rsi)  # store digit"
.STR303:    .string "    jmp .convert_loop"
.STR304:    .string ".convert_done:"
.STR305:    .string "    incq %rsi  # point to first character"
.STR306:    .string "    movq %rsi, %rcx  # Counter for strlen"
.STR307:    .string ".int_strlen_loop:"
.STR308:    .string "    je .int_strlen_done"
.STR309:    .string "    jmp .int_strlen_loop"
.STR310:    .string ".int_strlen_done:"
.STR311:    .string "    # %rsi already points to string"
.STR312:    .string ".newline:"
.STR313:    .string "    .byte 10  # newline character"
.STR314:    .string ".globl main"
.STR315:    .string ".section .note.GNU-stack"
