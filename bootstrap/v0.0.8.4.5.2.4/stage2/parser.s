...
.STR90:    .string "[PARSER ERROR] Expected 'Process' after 'Export'"
...
.globl statement_create_for_range_part1
statement_create_for_range_part1:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl statement_create_for_range_part2
statement_create_for_range_part2:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl statement_create_if_part1
statement_create_if_part1:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl statement_create_if_part2
statement_create_if_part2:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.L3662:
    ...
    popq %rdx
    popq %rcx
    call statement_create_for_range_part1
    movq %rax, -144(%rbp)
    movq -88(%rbp), %rax
    pushq %rax
    movq -80(%rbp), %rax
    ...
    popq %rsi
    popq %rdx
    call statement_create_for_range_part2
    pushq %rax
    leaq -144(%rbp), %rbx
    popq %rax
    movq %rax, (%rbx)
...
.L3671:    movq -80(%rbp), %rax
    ...
    popq %rsi
    popq %rdx
    call statement_create_if_part1
    movq %rax, -176(%rbp)
    movq $0, %rax
    pushq %rax
    movq $0, %rax
    ...
    popq %rsi
    popq %rdx
    call statement_create_if_part2
    pushq %rax
    leaq -176(%rbp), %rbx
    popq %rax
    movq %rax, (%rbx)
