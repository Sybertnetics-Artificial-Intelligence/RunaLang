...
.STR260:    .string "    # ERROR: Break statement outside of loop"
.STR261:    .string "    # ERROR: Break label not found: "
.STR262:    .string "    # ERROR: Continue statement outside of loop"
.STR263:    .string "    # ERROR: Continue label not found: "
.STR264:    .string "    # ERROR: Loop statement outside of loop"
.STR265:    .string "    movq $0, -"
.STR266:    .string "(%rbp)  # Zero array element"
.STR267:    .string "(%rbp)\n"
.STR268:    .string "List"
.STR269:    .string "    movq %rax, -"
.STR270:    .string "    movq %rax, (%rbx)"
.STR271:    .string "    movq (%rbx), %rcx"
.STR272:    .string "    addq %rax, %rcx"
.STR273:    .string "    subq %rax, %rcx"
.STR274:    .string "    imulq %rax, %rcx"
.STR275:    .string "    movq %rcx, %rax"
.STR276:    .string "    popq %rcx"
.STR277:    .string "    movq %rcx, (%rbx)"
.STR278:    .string ".L"
.STR279:    .string "    movq (%rsp), %rcx"
.STR280:    .string "    cmpq %rcx, %rax"
.STR281:    .string "    jg "
.STR282:    .string "    movq $1, %rax"
.STR283:    .string "    addq %rcx, %rax"
...
.STR382:    .string " as "
.STR383:    .string "[ERROR] codegen_generate: functions pointer is NULL"
...
.STR413:    .string "    # Convert integer to string"
.STR414:    .string "    movq %rdi, %rax  # integer value"
.STR415:    .string "    leaq -32(%rbp), %rsi  # buffer pointer"
.STR416:    .string "    addq $19, %rsi  # point to end of buffer (for reverse building)"
.STR417:    .string "    movb $0, (%rsi)  # null terminator"
.STR418:    .string "    decq %rsi"
.STR419:    .string "    # Handle zero case"
.STR420:    .string "    jnz .convert_loop"
.STR421:    .string "    movb $48, (%rsi)  # '0' character"
.STR422:    .string "    jmp .convert_done"
.STR423:    .string ".convert_loop:"
.STR424:    .string "    jz .convert_done"
.STR425:    .string "    movq $10, %rbx"
.STR426:    .string "    xorq %rdx, %rdx"
.STR427:    .string "    divq %rbx  # %rax = quotient, %rdx = remainder"
.STR428:    .string "    addq $48, %rdx  # convert remainder to ASCII"
.STR429:    .string "    movb %dl, (%rsi)  # store digit"
.STR430:    .string "    jmp .convert_loop"
.STR431:    .string ".convert_done:"
.STR432:    .string "    incq %rsi  # point to first character"
.STR433:    .string "    movq %rsi, %rcx  # Counter for strlen"
.STR434:    .string ".int_strlen_loop:"
.STR435:    .string "    je .int_strlen_done"
.STR436:    .string "    jmp .int_strlen_loop"
.STR437:    .string ".int_strlen_done:"
.STR438:    .string "    # %rsi already points to string"
.STR439:    .string ".section .rodata"
.STR440:    .string ".newline:"
.STR441:    .string "    .byte 10  # newline character"
.STR442:    .string "    .string "
.STR443:    .string ".globl main"
.STR444:    .string ".null_pointer_error:"
.STR445:    .string "    # Print error message for null pointer"
.STR446:    .string "    leaq .null_pointer_msg(%rip), %rdi"
.STR447:    .string "    call print_string@PLT"
.STR448:    .string "    # Exit with error code"
.STR449:    .string "    movq $1, %rdi"
.STR450:    .string "    call exit_with_code@PLT"
.STR451:    .string ".bounds_error_negative:"
.STR452:    .string "    # Print error message for negative index"
.STR453:    .string "    leaq .bounds_error_negative_msg(%rip), %rdi"
.STR454:    .string "    # Print the negative index value"
.STR455:    .string "    movq %rbx, %rdi  # Index value"
.STR456:    .string "    call print_integer@PLT"
.STR457:    .string ".bounds_error_overflow:"
.STR458:    .string "    # Save registers that will be clobbered"
.STR459:    .string "    pushq %rcx  # Save array size"
.STR460:    .string "    pushq %rbx  # Save index"
.STR461:    .string "    # Print error message for out-of-bounds index"
.STR462:    .string "    leaq .bounds_error_overflow_msg(%rip), %rdi"
.STR463:    .string "    # Print the index value"
.STR464:    .string "    popq %rdi  # Restore and use index"
.STR465:    .string "    pushq %rdi  # Save again for later"
.STR466:    .string "    # Print size message"
.STR467:    .string "    leaq .bounds_error_size_msg(%rip), %rdi"
.STR468:    .string "    # Print the array size"
.STR469:    .string "    movq 8(%rsp), %rdi  # Get saved array size from stack"
.STR470:    .string "    # Clean up stack"
.STR471:    .string "    addq $16, %rsp"
.STR472:    .string ".null_pointer_msg:"
.STR473:    .string "    .byte 70,65,84,65,76,32,69,82,82,79,82,58,32"
.STR474:    .string "    .byte 78,117,108,108,32,112,111,105,110,116,101,114,32"
.STR475:    .string "    .byte 100,101,114,101,102,101,114,101,110,99,101"
.STR476:    .string "    .byte 10,0"
.STR477:    .string ".bounds_error_negative_msg:"
.STR478:    .string "    .byte 65,114,114,97,121,32,105,110,100,101,120,32"
.STR479:    .string "    .byte 105,115,32,110,101,103,97,116,105,118,101,58,32"
.STR480:    .string "    .byte 0"
.STR481:    .string ".bounds_error_overflow_msg:"
.STR482:    .string "    .byte 111,117,116,32,111,102,32,98,111,117,110,100,115,58,32"
.STR483:    .string ".bounds_error_size_msg:"
.STR484:    .string "    .byte 32,40,97,114,114,97,121,32,115,105,122,101,32,105,115,32"
.STR485:    .string "    .byte 41,10,0"
.STR486:    .string ".section .note.GNU-stack"
.STR487:    .string "[WARNING] Recursive function detected: "
.STR488:    .string "          Stack overflow possible. Consider tail call optimization or iterative approach.\n"
.STR489:    .string "    # Stack overflow protection"
.STR490:    .string "    movq %rsp, %rax"
.STR491:    .string "    subq $16384, %rax  # Check if we have 16KB stack space"
.STR492:    .string "    cmpq $0x100000, %rax  # Compare against 1MB limit"
.STR493:    .string "    jb .stack_overflow_panic"
.STR494:    .string "# Stack overflow panic handler"
.STR495:    .string ".stack_overflow_panic:"
.STR496:    .string "    # Print error message"
.STR497:    .string "    leaq .stack_overflow_msg(%rip), %rdi"
.STR498:    .string ".stack_overflow_msg:"
.STR499:    .string "    .byte 83,116,97,99,107,32,111,118,101,114,102,108,111,119,32"
.STR500:    .string "    .byte 100,101,116,101,99,116,101,100"
.text
