...
// FIX: Return int64_t with explicit sign-extension (fixes sign-extension bug)
int64_t memory_get_int32(void* ptr, int64_t offset) {
    int32_t value = *(int32_t*)((char*)ptr + offset);
    return (int64_t)value;  // Explicit sign-extension from int32_t to int64_t
}
...
// Additional sized memory access functions for advanced type system
int64_t memory_get_int8(void* ptr, int64_t offset) {
    int8_t value = *(int8_t*)((char*)ptr + offset);
    return (int64_t)value;  // Sign-extend int8_t to int64_t
}

void memory_set_int8(void* ptr, int64_t offset, int8_t value) {
    *(int8_t*)((char*)ptr + offset) = value;
}

int64_t memory_get_int16(void* ptr, int64_t offset) {
    int16_t value = *(int16_t*)((char*)ptr + offset);
    return (int64_t)value;  // Sign-extend int16_t to int64_t
}

void memory_set_int16(void* ptr, int64_t offset, int16_t value) {
    *(int16_t*)((char*)ptr + offset) = value;
}

int64_t memory_get_uint8(void* ptr, int64_t offset) {
    uint8_t value = *(uint8_t*)((char*)ptr + offset);
    return (int64_t)value;  // Zero-extend uint8_t to int64_t
}

void memory_set_uint8(void* ptr, int64_t offset, uint8_t value) {
    *(uint8_t*)((char*)ptr + offset) = value;
}

int64_t memory_get_uint16(void* ptr, int64_t offset) {
    uint16_t value = *(uint16_t*)((char*)ptr + offset);
    return (int64_t)value;  // Zero-extend uint16_t to int64_t
}

void memory_set_uint16(void* ptr, int64_t offset, uint16_t value) {
    *(uint16_t*)((char*)ptr + offset) = value;
}

int64_t memory_get_uint32(void* ptr, int64_t offset) {
    uint32_t value = *(uint32_t*)((char*)ptr + offset);
    return (int64_t)value;  // Zero-extend uint32_t to int64_t
}

void memory_set_uint32(void* ptr, int64_t offset, uint32_t value) {
    *(uint32_t*)((char*)ptr + offset) = value;
}

// 128-bit integer support (using two 64-bit words)
// Layout: [low 64 bits][high 64 bits]

void memory_get_int128(void* ptr, int64_t offset, int64_t* low_out, int64_t* high_out) {
    *low_out = *(int64_t*)((char*)ptr + offset);
    *high_out = *(int64_t*)((char*)ptr + offset + 8);
}

void memory_set_int128(void* ptr, int64_t offset, int64_t low, int64_t high) {
    *(int64_t*)((char*)ptr + offset) = low;
    *(int64_t*)((char*)ptr + offset + 8) = high;
}
...
// 256-bit integer support (using four 64-bit words)
// Layout: [word0][word1][word2][word3]
void memory_get_int256(void* ptr, int64_t offset, int64_t* out) {
    int64_t* src = (int64_t*)((char*)ptr + offset);
    out[0] = src[0];
    out[1] = src[1];
    out[2] = src[2];
    out[3] = src[3];
...
void memory_set_int256(void* ptr, int64_t offset, int64_t* in) {
    int64_t* dest = (int64_t*)((char*)ptr + offset);
    dest[0] = in[0];
    dest[1] = in[1];
    dest[2] = in[2];
    dest[3] = in[3];
...
// 512-bit integer support (using eight 64-bit words)
// Layout: [word0][word1][word2][word3][word4][word5][word6][word7]
void memory_get_int512(void* ptr, int64_t offset, int64_t* out) {
    int64_t* src = (int64_t*)((char*)ptr + offset);
    for (int i = 0; i < 8; i++) {
        out[i] = src[i];
    }
...
void memory_set_int512(void* ptr, int64_t offset, int64_t* in) {
    int64_t* dest = (int64_t*)((char*)ptr + offset);
    for (int i = 0; i < 8; i++) {
        dest[i] = in[i];
    }
