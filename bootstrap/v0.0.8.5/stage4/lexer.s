...
.globl TOKEN_JOINED
TOKEN_JOINED:    .quad 163
.globl TOKEN_CHAR_LITERAL
TOKEN_CHAR_LITERAL:    .quad 164
.globl TOKEN_THROUGH
TOKEN_THROUGH:    .quad 165
...
.STR47:    .string "in"
.STR48:    .string "index"
.STR49:    .string "increased"
.STR50:    .string "equal"
.STR51:    .string "each"
.STR52:    .string "less"
.STR53:    .string "length"
.STR54:    .string "lambda"
.STR55:    .string "greater"
.STR56:    .string "gets"
.STR57:    .string "not"
.STR58:    .string "negative"
.STR59:    .string "and"
.STR60:    .string "as"
.STR61:    .string "at"
.STR62:    .string "an"
...
.STR71:    .string "false"
.STR72:    .string "from"
.STR73:    .string "divided"
.STR74:    .string "decreased"
.STR75:    .string "Display"
.STR76:    .string "Decrease"
.STR77:    .string "Divide"
.STR78:    .string "Multiply"
.STR79:    .string "Match"
.STR80:    .string "For"
.STR81:    .string "where"
.STR82:    .string "with"
.STR83:    .string "key"
.STR84:    .string "string_length"
.STR85:    .string "read_file"
.STR86:    .string "write_file"
.STR87:    .string "memory_get_byte"
.STR88:    .string "memory_set_byte"
.STR89:    .string "-"
.STR90:    .string ":"
.STR91:    .string "("
.STR92:    .string ")"
...
.globl token_create_int_value
token_create_int_value:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl lexer_read_char_literal
lexer_read_char_literal:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.L661:
    ...
    movq -128(%rbp), %rax
    pushq %rax
    movq $164, %rax  # Load compile-time constant TOKEN_CHAR_LITERAL
    pushq %rax
    popq %rdi
    popq %rsi
    popq %rdx
    popq %rcx
    call token_create_int_value
    movq %rax, -80(%rbp)
    movq -80(%rbp), %rax
    movq %rbp, %rsp
    popq %rbp
...
.L1401:
    ...
    testq %rax, %rax
    jz .L1411
    movq $165, %rax  # Load compile-time constant TOKEN_THROUGH
    movq %rbp, %rsp
    popq %rbp
    ret
    jmp .L1412
...
check_keywords_j:
    ...
    testq %rax, %rax
    jz .L1511
    movq $163, %rax  # Load compile-time constant TOKEN_JOINED
    movq %rbp, %rsp
    popq %rbp
    ret
    jmp .L1512
