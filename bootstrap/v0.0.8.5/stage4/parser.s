...
parser_parse_primary_with_postfix:
    ...
    movq -40(%rbp), %rax
    pushq %rax
    movq $10, %rax  # Load compile-time constant EXPR_FUNCTION_POINTER
    popq %rbx
    cmpq %rax, %rbx
    sete %al
    movzbq %al, %rax
