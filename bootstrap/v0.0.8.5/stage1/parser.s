...
EXPR_RANGE:    .quad 26
.globl EXPR_TERNARY
EXPR_TERNARY:    .quad 27
.globl EXPR_STRING_INTERPOLATION
EXPR_STRING_INTERPOLATION:    .quad 28
.globl STMT_LET
STMT_LET:    .quad 1
.globl STMT_SET
STMT_SET:    .quad 2
...
parser_parse_expression:
    ...
    pushq %rax
    popq %rdi
    call parser_parse_ternary
    movq %rbp, %rsp
    popq %rbp
    ret


.globl parser_parse_ternary
parser_parse_ternary:
    pushq %rbp
    movq %rsp, %rbp
    # Stack overflow protection
    movq %rsp, %rax
    ...
    popq %rsi
    popq %rdx
    call expression_create_ternary
    movq %rax, -64(%rbp)
    movq -64(%rbp), %rax
    movq %rbp, %rsp
    popq %rbp
...
.globl expression_create_ternary
expression_create_ternary:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
    ...
    call memory_allocate@PLT
    movq %rax, -40(%rbp)
    movq $27, %rax  # Load compile-time constant EXPR_TERNARY
    pushq %rax
    movq $0, %rax
    pushq %rax
    movq -40(%rbp), %rax
...
.globl parser_parse_fstring
parser_parse_fstring:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
