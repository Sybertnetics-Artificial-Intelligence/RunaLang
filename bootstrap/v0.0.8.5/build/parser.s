...
.STR50:    .string "[PARSER ERROR] Expected 'to' or 'through' in for-range statement\n"
...
.globl parser_is_function_name
parser_is_function_name:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.L401:
    ...
    popq %rsi
    popq %rdx
    call expression_create_indirect_call
    movq %rax, -176(%rbp)
    movq -176(%rbp), %rax
    pushq %rax
    leaq -16(%rbp), %rbx
...
.globl expression_create_indirect_call
expression_create_indirect_call:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
    ...
    call memory_allocate@PLT
    movq %rax, -40(%rbp)
    movq $11, %rax  # Load compile-time constant EXPR_INDIRECT_CALL
    pushq %rax
    movq $0, %rax
    pushq %rax
    movq -40(%rbp), %rax
