...
TOKEN_FLOAT_LITERAL:    .quad 165
.globl TOKEN_FLOAT16_TYPE
TOKEN_FLOAT16_TYPE:    .quad 166
.globl TOKEN_FLOAT32_TYPE
TOKEN_FLOAT32_TYPE:    .quad 167
.globl TOKEN_FLOAT64_TYPE
TOKEN_FLOAT64_TYPE:    .quad 168
.globl TOKEN_FLOAT80_TYPE
TOKEN_FLOAT80_TYPE:    .quad 169
.globl TOKEN_FLOAT128_TYPE
TOKEN_FLOAT128_TYPE:    .quad 170
...
.STR77:    .string "Match"
.STR78:    .string "For"
.STR79:    .string "Float16"
.STR80:    .string "Float32"
.STR81:    .string "Float64"
.STR82:    .string "Float80"
.STR83:    .string "Float128"
.STR84:    .string "where"
.STR85:    .string "with"
.STR86:    .string "key"
.STR87:    .string "string_length"
.STR88:    .string "read_file"
.STR89:    .string "write_file"
.STR90:    .string "memory_get_byte"
.STR91:    .string "memory_set_byte"
.STR92:    .string "-"
.STR93:    .string ":"
.STR94:    .string "("
.STR95:    .string ")"
...
.L692:
    ...
    testq %rax, %rax
    jz .L711
    movq $165, %rax  # Load compile-time constant TOKEN_FLOAT_LITERAL
    pushq %rax
    movq $0, %rax
    pushq %rax
    movq -16(%rbp), %rax
...
.L1441:
    ...
    testq %rax, %rax
    jz .L1451
    movq $164, %rax  # Load compile-time constant TOKEN_LOOP
    movq %rbp, %rsp
    popq %rbp
    ret
    jmp .L1452
...
.L1981:
    ...
    testq %rax, %rax
    jz .L1991
    movq $166, %rax  # Load compile-time constant TOKEN_FLOAT16_TYPE
    movq %rbp, %rsp
    popq %rbp
    ret
    jmp .L1992
.L1991:
    ...
    testq %rax, %rax
    jz .L2001
    movq $167, %rax  # Load compile-time constant TOKEN_FLOAT32_TYPE
    movq %rbp, %rsp
    popq %rbp
    ret
    jmp .L2002
.L2001:
    ...
    testq %rax, %rax
    jz .L2011
    movq $168, %rax  # Load compile-time constant TOKEN_FLOAT64_TYPE
    movq %rbp, %rsp
    popq %rbp
    ret
    jmp .L2012
.L2011:
    ...
    testq %rax, %rax
    jz .L2021
    movq $169, %rax  # Load compile-time constant TOKEN_FLOAT80_TYPE
    movq %rbp, %rsp
    popq %rbp
    ret
    jmp .L2022
.L2021:
    ...
    testq %rax, %rax
    jz .L2031
    movq $170, %rax  # Load compile-time constant TOKEN_FLOAT128_TYPE
    movq %rbp, %rsp
    popq %rbp
    ret
    jmp .L2032
