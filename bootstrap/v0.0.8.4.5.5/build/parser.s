...
.STR44:    .string "[PARSER ERROR] Expected string literal after Loop keyword\n"
...
.globl expression_create_float_literal
expression_create_float_literal:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
    ...
    call memory_allocate@PLT
    movq %rax, -32(%rbp)
    movq $25, %rax  # Load compile-time constant EXPR_FLOAT_LITERAL
    pushq %rax
    movq $0, %rax
    pushq %rax
    movq -32(%rbp), %rax
...
.globl statement_create_loop
statement_create_loop:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
    ...
    call memory_allocate@PLT
    movq %rax, -24(%rbp)
    movq $14, %rax  # Load compile-time constant STMT_LOOP
    pushq %rax
    movq $0, %rax
    pushq %rax
    movq -24(%rbp), %rax
...
.L1812:
    ...
    popq %rdi
    popq %rsi
    call expression_create_float_literal
    pushq %rax
    leaq -216(%rbp), %rbx
    popq %rax
    movq %rax, (%rbx)
...
.globl parser_parse_loop_statement
parser_parse_loop_statement:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.L3512:
    ...
    pushq %rax
    popq %rdi
    call parser_parse_loop_statement
    pushq %rax
    leaq -64(%rbp), %rbx
    popq %rax
    movq %rax, (%rbx)
