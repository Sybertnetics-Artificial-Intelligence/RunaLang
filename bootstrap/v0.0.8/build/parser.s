...
.STR18:    .string "Error: Expected identifier after For"
.STR19:    .string "[PARSER ERROR] Expected Note: comment after assembly instruction at line "
.STR20:    .string "Assembly instruction"
...
.STR56:    .string "[PROF] parse_expression calls:"
.STR57:    .string "[PROF] parse_primary calls:"
.STR58:    .string "[PROF] eat_token calls:"
.STR59:    .string "[PROF] string_duplicate calls:"
...
.globl PROGRAM_TYPE_HASHTABLE
PROGRAM_TYPE_HASHTABLE:    .quad 64
.globl PROGRAM_FUNCTION_CACHE
PROGRAM_FUNCTION_CACHE:    .quad 72
.globl EXPR_INTEGER
EXPR_INTEGER:    .quad 0
.globl EXPR_VARIABLE
...
.globl PARSER_PERF_COUNTERS
PARSER_PERF_COUNTERS:    .quad 24
...
.globl STMT_FOR_STEP
STMT_FOR_STEP:    .quad 32
.globl STMT_FOR_BODY
STMT_FOR_BODY:    .quad 40
.globl STMT_FOR_BODY_COUNT
STMT_FOR_BODY_COUNT:    .quad 48
...
.globl parser_parse_bitwise_or
parser_parse_bitwise_or:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl parser_parse_bitwise_xor
parser_parse_bitwise_xor:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl parser_parse_bitwise_and
parser_parse_bitwise_and:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl parser_parse_increase_statement
parser_parse_increase_statement:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl parser_parse_decrease_statement
parser_parse_decrease_statement:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl parser_parse_multiply_statement
parser_parse_multiply_statement:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl parser_parse_divide_statement
parser_parse_divide_statement:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.globl statement_create_for
statement_create_for:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    movq %rdi, -8(%rbp)
...
.L1422:
    ...
    popq %rdx
    call memory_set_int32@PLT
    movq $72, %rax  # Load compile-time constant PROGRAM_FUNCTION_CACHE
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rdi
...
.L1492:
    ...
    popq %rdx
    call memory_set_int32@PLT
    movq $64, %rax  # Load compile-time constant PROGRAM_TYPE_HASHTABLE
    pushq %rax
    movq -8(%rbp), %rax
    pushq %rax
    popq %rdi
...
.L2222:
    ...
    pushq %rax
    popq %rdi
    call parser_parse_increase_statement
    pushq %rax
    leaq -64(%rbp), %rbx
    popq %rax
    movq %rax, (%rbx)
...
.L2232:
    ...
    pushq %rax
    popq %rdi
    call parser_parse_decrease_statement
    pushq %rax
    leaq -64(%rbp), %rbx
    popq %rax
    movq %rax, (%rbx)
...
.L2242:
    ...
    pushq %rax
    popq %rdi
    call parser_parse_multiply_statement
    pushq %rax
    leaq -64(%rbp), %rbx
    popq %rax
    movq %rax, (%rbx)
...
.L2252:
    ...
    pushq %rax
    popq %rdi
    call parser_parse_divide_statement
    pushq %rax
    leaq -64(%rbp), %rbx
    popq %rax
    movq %rax, (%rbx)
...
parser_parse_program:
    ...
    popq %rdx
    call memory_set_pointer@PLT
    movq $80, %rax  # Load compile-time constant SIZEOF_PROGRAM
    pushq %rax
    popq %rdi
    call memory_allocate@PLT
    movq %rax, -24(%rbp)
