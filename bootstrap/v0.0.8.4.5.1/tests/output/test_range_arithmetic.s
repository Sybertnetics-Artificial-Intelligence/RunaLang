...
.STR0:    .string "Test: Simple Addition"
.STR1:    .string "  ✓ PASS"
.STR2:    .string "  ✗ FAIL"
.STR3:    .string "Test: Subtraction"
.STR4:    .string "Test: Multiplication"
.STR5:    .string "Test: Division"
.STR6:    .string "Test: Modulo"
.STR7:    .string "Test: Known Small Range (should use Integer8)"
.STR8:    .string "  ✓ PASS - Range [0,100]"
.STR9:    .string "===== Range Analysis Test Suite ====="
.STR10:    .string ""
.STR11:    .string "===== Results ====="
.STR12:    .string "Passed: "
.STR13:    .string " / "
.STR14:    .string " - ALL TESTS PASSED!"
.STR15:    .string " - SOME TESTS FAILED"
.text


.globl test_simple_addition
...
.globl test_known_small_range
test_known_small_range:
    pushq %rbp
    movq %rsp, %rbp
    subq $2048, %rsp  # Pre-allocate generous stack space
    leaq .STR7(%rip), %rax
